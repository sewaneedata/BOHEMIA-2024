...
# RAIN AND TEMP DATA FOR KWALE

  weather <- cloudbrewr::aws_s3_get_table(
    bucket = 'bohemia-external-data-repository',
    key = glue::glue('environmental/rain_and_temperature_data/rain_temp_ke.csv')) 
  
  # save the csv files
  write_csv(weather, file = 'kwale_weather.csv')
