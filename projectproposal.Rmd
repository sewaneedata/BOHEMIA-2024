...
The code that creates this work can be found [here](https://github.com/sewaneedata/BOHEMIA-2024). We worked with 10 datasets in total. Some of the datasets can be found [here](), and the remaining datasets are retrieved by the `data.R` script.
